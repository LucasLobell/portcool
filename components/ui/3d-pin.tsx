    ...
    <motion.div className="pointer-events-none  w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none inset-0">
        <div className="absolute top-0 inset-x-0 flex justify-center">
          ...
          >
            <span className="relative w-max z-20 text-white text-xs font-bold inline-block py-0.5">
              {title}
            </span>
        ...
        <>
          ...
          <motion.div className="absolute right-1/2 translate-x-[0.5px] bottom-1/2 bg-cyan-500 translate-y-[14px] w-[2px] h-[2px] rounded-full z-40 " />
        </>
      </div>
    </motion.div>
  );
